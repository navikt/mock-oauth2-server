...
suspend fun HttpClient.tokenRequest(
    url: String,
    auth: Auth,
...
suspend fun HttpClient.clientCredentialsGrant(
    url: String,
    auth: Auth,
    scope: String,
) = tokenRequest(
...
suspend fun HttpClient.onBehalfOfGrant(
    url: String,
    auth: Auth,
    token: String,
    scope: String,
...
class Auth internal constructor(
    ...
    companion object {
        ...
        fun privateKeyJwt(jwt: String): Auth =
            Auth(
                parameters =
                    mapOf(
